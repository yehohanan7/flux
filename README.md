...
### Aggregate
Flux suggests that you follow the principles of DDD while modeling your aggregates [Aggregate](https://martinfowler.com/bliki/DDD_Aggregate.html), which accepts commands and publishes events.
